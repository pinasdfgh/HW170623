...
class auidoVC: UIViewController,MPMediaPickerControllerDelegate {
    ...
    @IBAction func start(_ sender: Any) {
        if isplyer{
            ...
            if #available(iOS 10.0, *) {
                ...
                // timeInterval unit:0.1 milliseconds
                print("IN")
    ...
    override func viewDidLoad() {
        ...
        let url = Bundle.main.url(forResource: "01. SAVIOR OF SONG (feat. MY FIRST STORY)", withExtension: "mp3")
        do{
